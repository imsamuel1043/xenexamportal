        ...
        <>
            <aside className={sidebarcss.sidebar}>
                ...
                <ul className={sidebarcss.sidebarlist}>
                    <h6 className={sidebarcss.headings}><span>Main</span></h6>
                    ...
                    <h6 className={sidebarcss.headings}><span>Academic</span></h6>
                    ...
                    <h6 className={sidebarcss.headings}><span>Masters</span></h6>
                    <li className={sidebarcss.sidebarlistitem}><Link to="/managment"><i className="bi bi-person-lines-fill"></i> <span>User Management</span></Link></li>
                    <li className={sidebarcss.sidebarlistitem}><Link to="/group"><i className="bi bi-person-plus-fill"></i> <span>User Group</span></Link></li>
                    <li className={sidebarcss.sidebarlistitem}><Link to="/permission"><i className="bi bi-shield-check"></i> <span>Permission</span></Link></li>
